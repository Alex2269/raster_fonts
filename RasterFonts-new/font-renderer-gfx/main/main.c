...
int main(void) {
    ...
    DrawTextScaled(Pixel_font, 30, 260, "Масштабований текст x2", spacing, 2, BLUE); // масштаб 2x
    DrawTextScaled(FreePixel_font, 30, 290, "Масштабований текст x2", spacing, 2, RED); // масштаб 2x
